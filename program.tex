...
\\
\subfigure[]{\includegraphics[scale=0.6]{SigmaLDFA}}
...
\begin{figure}[H]
\centering
\subfigure[\ref{diag6}]{\includegraphics[scale=0.3]{Sigma6}}
\subfigure[\ref{diag3G}]{\includegraphics[scale=0.3]{Sigma3G}}
